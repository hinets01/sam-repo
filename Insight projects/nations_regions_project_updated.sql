...
CREATE TABLE central_insights_sandbox.sho_nations_regions_sport_regression_
(
  bbc_hid3 VARCHAR(4000),
  acorn_category VARCHAR(4000),
  age_range VARCHAR(4000),
  ...
  is_east VARCHAR(1),
  is_london VARCHAR(1),
  is_east_mids VARCHAR(1),
  is_west_mids VARCHAR(1),
  is_NE_cumbria VARCHAR(1),
  is_north_west VARCHAR(1),
  is_scotland_barb VARCHAR(1),
  is_south VARCHAR(1),
  is_south_east VARCHAR(1),
  is_south_west VARCHAR(1),
  is_ulster VARCHAR(1),
  is_wales_barb VARCHAR(1),
  is_west VARCHAR(1),
  is_yorks_lincs VARCHAR(1)
)
;

INSERT INTO central_insights_sandbox.sho_nations_regions_sport_regression
SELECT
  bbc_hid3,
  acorn_category,
  age_range,
  ...
  CASE WHEN barb_region = 'East of England' THEN '1' ELSE '0' END,
  CASE WHEN barb_region = 'London' THEN '1' ELSE '0' END,
  CASE WHEN barb_region = 'Midlands East' THEN '1' ELSE '0' END,
  CASE WHEN barb_region = 'Midlands West' THEN '1' ELSE '0' END,
  CASE WHEN barb_region = 'North East and Cumbria' THEN '1' ELSE '0' END,
  CASE WHEN barb_region = 'North West' THEN '1' ELSE '0' END,
  CASE WHEN barb_region = 'Scotland' THEN '1' ELSE '0' END,
  CASE WHEN barb_region = 'South' THEN '1' ELSE '0' END,
  CASE WHEN barb_region = 'South East' THEN '1' ELSE '0' END,
  CASE WHEN barb_region = 'South West' THEN '1' ELSE '0' END,
  CASE WHEN barb_region = 'Ulster' THEN '1' ELSE '0' END,
  CASE WHEN barb_region = 'Wales' THEN '1' ELSE '0' END,
  CASE WHEN barb_region = 'West' THEN '1' ELSE '0' END,
  CASE WHEN barb_region = 'Yorkshire and Lincolnshire' THEN '1' ELSE '0' END
FROM central_insights_sandbox.sho_nations_regions_sport_data
  WHERE
    age_range NOTNULL
...
CREATE TABLE central_insights_sandbox.sho_nations_regions_iplayer_daycount
AS
...
ALTER TABLE central_insights_sandbox.sho_nations_regions_homepage_regression
    ADD COLUMN days_visited INT;
UPDATE central_insights_sandbox.sho_nations_regions_homepage_regression
    SET days_visited = central_insights_sandbox.sho_nations_regions_homepage_daycount.count
FROM central_insights_sandbox.sho_nations_regions_homepage_daycount
WHERE central_insights_sandbox.sho_nations_regions_homepage_daycount.bbc_hid3 = central_insights_sandbox.sho_nations_regions_homepage_regression.bbc_hid3;
